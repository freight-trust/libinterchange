...
structure = [
    {
        ...
        LEVEL: [
            ...
            { ID: "PAM", MIN: 0, MAX: 10 },
            { ID: "CSH", MIN: 0, MAX: 1 },
            { ID: "SAC", MIN: 0, MAX: 25, LEVEL: [{ ID: "CUR", MIN: 0, MAX: 1 }] },
            { ID: "ITD", MIN: 0, MAX: 5 },
            { ID: "DIS", MIN: 0, MAX: 20 },
            { ID: "INC", MIN: 0, MAX: 1 },
            { ID: "DTM", MIN: 0, MAX: 10 },
            ...
            { ID: "AMT", MIN: 0, MAX: 99999, LEVEL: [{ ID: "PCT", MIN: 0, MAX: 99999 }] },
            {
                ID: "ADV",
                MIN: 0,
                MAX: 99999,
            ...
            { ID: "LM", MIN: 0, MAX: 99999, LEVEL: [{ ID: "LQ", MIN: 1, MAX: 99999 }] },
            {
                ...
                LEVEL: [
                    ...
                    },
                    {
                        ...
                        MIN: 0,
                        MAX: 99999,
                        LEVEL: [{ ID: "PCT", MIN: 0, MAX: 99999 }],
                    },
                    {
                        ID: "QTY",
                        MIN: 0,
                        MAX: 99999,
                        LEVEL: [{ ID: "SI", MIN: 0, MAX: 99999 }],
                    },
                    {
                        ID: "SCH",
                        MIN: 0,
            ...
            { ID: "CTT", MIN: 0, MAX: 1, LEVEL: [{ ID: "AMT", MIN: 0, MAX: 5 }] },
            { ID: "SE", MIN: 1, MAX: 1 },
        ],
    },
];
